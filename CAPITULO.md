...
| **3. Quanto dura o par moderno — o número global** | oito registros nacionais: sobrevida livre de revisão **93,6% (IC 92,3–94,7) aos 20 ANOS** — este é o horizonte mais longo que o estudo reporta a partir de dado real de registro; o resumo **não publica valores de 10 nem de 15 anos** | **Pentland 2026 · Lancet · revisão sistemática + metanálise · 1.904.237 ATQs · [PMID 41763743](https://pubmed.ncbi.nlm.nih.gov/41763743/)** — ⚠️ os valores de **25 anos (92,8%) e 30 anos (92,1%) são EXTRAPOLADOS** por modelo, **não observados**: nunca citá-los sem dizer isso. E o resumo **não publica a quebra por par tribológico** |
