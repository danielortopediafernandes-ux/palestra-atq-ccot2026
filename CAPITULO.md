...
| **3. Quanto dura o par moderno — o número global** | oito registros nacionais: sobrevida livre de revisão **93,6% (IC 92,3–94,7) em 20 anos** | **Pentland 2026 · Lancet · revisão sistemática + metanálise · 1.904.237 ATQs · [PMID 41763743](https://pubmed.ncbi.nlm.nih.gov/41763743/)** — ⚠️ os valores de **25 anos (92,8%) e 30 anos (92,1%) são EXTRAPOLADOS** por modelo, **não observados**: nunca citá-los sem dizer isso. E o resumo **não publica a quebra por par tribológico** |
...
| 🎯 **8. A síntese que amarra [4.3] e [4.4]** | no **mesmo** estudo, cabeças **≥ 36 mm** tiveram **HR 3,2 (1,9–5,3)** de revisão por ARMD contra ≤ 32 mm — **mas** o risco esteve associado às cabeças de **cobalto-cromo** e a duas hastes específicas (Accolade I, HR 8,3; M/L Taper, HR 14,4). Portanto isto **não** é argumento contra o 36 mm: é argumento a favor do **36 mm DE CERÂMICA** | de Steiger 2020 · [PMID 32345846](https://pubmed.ncbi.nlm.nih.gov/32345846/) · **clássico: mesma fonte da linha 7 — é a única análise de registro que estratifica o ARMD por tamanho de cabeça E por material** |
